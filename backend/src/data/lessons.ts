...
export const LESSONS: Lesson[] = [
    ...
    },
    {
        ...
        quiz: [
            { question: 'หุ้น Growth คือหุ้นแบบไหน?', options: ['หุ้นที่จ่ายเงินปันผลสูง', 'หุ้นที่มีรายได้และกำไรเติบโตเร็วกว่าค่าเฉลี่ย', 'หุ้นที่ราคาถูกกว่ามูลค่าจริง', 'หุ้นของบริษัทขนาดเล็ก'], answer: 1 },
            { question: 'Dividend Yield ที่ดีอยู่ในช่วงใด?', options: ['0-1%', '2-6%', '10-20%', 'มากกว่า 30%'], answer: 1 },
            { question: 'หุ้น Blue-Chip เหมาะกับใคร?', options: ['เฉพาะนักเทรดรายวัน', 'มือใหม่ที่ต้องการเริ่มต้นอย่างมั่นคง', 'คนที่ต้องการกำไร 100% ใน 1 เดือน', 'เฉพาะนักลงทุนสถาบัน'], answer: 1 },
        ],
    },
    {
        ...
        quiz: [
            { question: 'ก่อนลงทุนควรมีเงินสำรองฉุกเฉินเท่าไหร่?', options: ['1 เดือน', '3-6 เดือน', '1 ปี', '5 ปี'], answer: 1 },
            { question: 'DCA คือกลยุทธ์อะไร?', options: ['ซื้อหุ้นตอนราคาต่ำสุดเท่านั้น', 'ลงทุนจำนวนเท่าๆ กันสม่ำเสมอ', 'ซื้อหุ้นทีละมากๆ', 'ขายหุ้นทุกวัน'], answer: 1 },
        ],
    },
    ...
    },
    {
        ...
        quiz: [
            { question: 'Net Income คืออะไร?', options: ['รายได้ทั้งหมดของบริษัท', 'กำไรสุทธิหลังหักค่าใช้จ่ายและภาษีทั้งหมด', 'ต้นทุนการผลิต', 'เงินสดในบัญชี'], answer: 1 },
            { question: 'Debt-to-Equity Ratio ที่ดีควรเป็นอย่างไร?', options: ['ยิ่งสูงยิ่งดี', 'ยิ่งต่ำยิ่งดี', 'ต้องเป็น 0 เท่านั้น', 'ไม่มีผลต่อการวิเคราะห์'], answer: 1 },
            { question: 'Free Cash Flow คำนวณจากอะไร?', options: ['Revenue - Expenses', 'Operating Cash Flow - Capital Expenditure', 'Net Income × PE', 'Total Assets - Total Liabilities'], answer: 1 },
        ],
    },
    {
        ...
        quiz: [
            { question: 'Golden Cross คืออะไร?', options: ['ราคาหุ้นทำ All-Time High', 'MA50 ตัด MA200 ขึ้น เป็นสัญญาณซื้อ', 'RSI มากกว่า 70', 'MACD เป็นลบ'], answer: 1 },
            { question: 'RSI มากกว่า 70 หมายถึงอะไร?', options: ['หุ้นราคาถูกน่าซื้อ', 'หุ้น Overbought อาจลงเร็วๆ นี้', 'ตลาดปิดทำการ', 'ควรซื้อเพิ่ม'], answer: 1 },
            { question: 'MACD ตัด Signal Line ขึ้น หมายถึง?', options: ['สัญญาณขาย', 'สัญญาณซื้อ (Bullish)', 'ตลาดปิด', 'ไม่มีความหมาย'], answer: 1 },
        ],
    },
    {
        ...
        quiz: [
            { question: 'Fundamental Analysis ดูอะไร?', options: ['กราฟราคาและ Volume', 'ตัวบริษัท: งบการเงิน, กำไร, การเติบโต', 'เฉพาะข่าวลือ', 'จำนวนคนที่ซื้อหุ้น'], answer: 1 },
            { question: 'Technical Analysis เหมาะกับการลงทุนแบบไหน?', options: ['ลงทุนระยะยาว 10 ปี', 'เทรดระยะสั้น (วัน-สัปดาห์)', 'ซื้อกองทุนรวม', 'ลงทุนในพันธบัตร'], answer: 1 },
        ],
    },
    {
        id: 'valuation-models',
    ...
    // ═══════════════════════════════════
    {
        ...
        quiz: [
            { question: 'DCA คืออะไร?', options: ['ซื้อหุ้นทีเดียวจำนวนมาก', 'ลงทุนจำนวนเท่ากันสม่ำเสมอ ไม่สนราคา', 'ขายหุ้นทุกเดือน', 'กู้เงินมาลงทุน'], answer: 1 },
            { question: 'ข้อดีของ DCA คืออะไร?', options: ['รวยภายใน 1 เดือน', 'ลดความเสี่ยงจากการจับจังหวะตลาด', 'ไม่ต้องเสียภาษี', 'ได้ผลตอบแทน 100% ทุกปี'], answer: 1 },
            { question: 'DCA เหมาะกับการลงทุนกี่ปีขึ้นไป?', options: ['1 เดือน', '6 เดือน', '1 ปี', '5 ปีขึ้นไป'], answer: 3 },
        ],
    },
    {
        ...
        quiz: [
            { question: 'Diversification คืออะไร?', options: ['ลงทุนหุ้นตัวเดียว 100%', 'กระจายลงทุนในสินทรัพย์หลายประเภทเพื่อลดความเสี่ยง', 'ขายหุ้นทุกตัวพร้อมกัน', 'กู้เงินมาลงทุนเพิ่ม'], answer: 1 },
            { question: 'พอร์ตมือใหม่ควรมีอะไรบ้าง?', options: ['หุ้นตัวเดียว 100%', 'Blue-Chip + Dividend + Index Fund ผสมกัน', 'เฉพาะเงินสด', 'เฉพาะ Options'], answer: 1 },
            { question: 'การกระจายข้ามภูมิศาสตร์หมายถึง?', options: ['ซื้อหุ้นจากหลายประเทศ', 'ซื้อหุ้นหลายตัวจากบริษัทเดียว', 'ซื้อหุ้นจากหลายโบรกเกอร์', 'ซื้อหุ้นในวันต่างกัน'], answer: 0 },
        ],
    },
    {
        ...
        quiz: [
            { question: 'ลงทุน $10,000 ผลตอบแทน 10%/ปี ปีที่ 30 จะมีเงินเท่าไหร่?', options: ['$40,000', '$100,000', 'ประมาณ $174,000', '$1,000,000'], answer: 2 },
            { question: 'ถ้าพลาด 10 วันที่ดีที่สุดของ S&P 500 ใน 30 ปี เกิดอะไรขึ้น?', options: ['ไม่มีผล', 'ผลตอบแทนลดลงครึ่งหนึ่ง', 'ได้กำไรเพิ่ม', 'เสียเงินทั้งหมด'], answer: 1 },
            { question: 'Warren Buffett แนะนำอะไรสำหรับคนทั่วไป?', options: ['เทรดทุกวัน', 'ลงทุนใน Bitcoin', 'DCA ในกองทุนดัชนี S&P 500', 'ซื้อหุ้น Penny Stock'], answer: 2 },
        ],
    },
    {
        id: 'options-trading',
    ...
    // ═══════════════════════════════════
    {
        ...
        quiz: [
            { question: 'Beta > 1 หมายถึงอะไร?', options: ['หุ้นผันผวนน้อยกว่าตลาด', 'หุ้นผันผวนมากกว่าตลาด', 'หุ้นไม่มีความเสี่ยง', 'หุ้นจ่ายปันผลสูง'], answer: 1 },
            { question: 'ความเสี่ยงประเภทใดที่กระจายพอร์ตช่วยลดได้?', options: ['Market Risk', 'Company Risk และ Sector Risk', 'Inflation Risk', 'Currency Risk เท่านั้น'], answer: 1 },
            { question: 'ผลตอบแทนสูง = ?', options: ['ไม่มีความเสี่ยง', 'ความเสี่ยงสูง', 'รับประกันกำไร', 'ค่าธรรมเนียมสูง'], answer: 1 },
        ],
    },
    {
        id: 'stop-loss',
        ...
        quiz: [
            { question: 'Stop Loss คืออะไร?', options: ['คำสั่งซื้อหุ้นเพิ่ม', 'คำสั่งขายอัตโนมัติเมื่อราคาลงถึงจุดที่กำหนด', 'คำสั่งห้ามขายหุ้น', 'ค่าธรรมเนียมพิเศษ'], answer: 1 },
            { question: 'หุ้น Blue-Chip ควรตั้ง Stop Loss กี่เปอร์เซ็นต์?', options: ['1-2%', '7-10%', '30-40%', '50%'], answer: 1 },
            { question: 'Trailing Stop Loss ทำงานอย่างไร?', options: ['ตั้งไว้ที่ราคาเดิมตลอด', 'ขยับขึ้นตามราคาที่ขึ้น ช่วยล็อคกำไร', 'ขยับลงตามราคาที่ลง', 'ยกเลิกอัตโนมัติหลัง 1 วัน'], answer: 1 },
        ],
    },
    {
        id: 'common-mistakes',
        ...
        quiz: [
            { question: 'FOMO คืออะไร?', options: ['กลยุทธ์การลงทุนขั้นสูง', 'กลัวพลาดโอกาส ซื้อตามกระแสโดยไม่วิเคราะห์', 'การขายหุ้นทิ้งตอนกลัว', 'ชื่อแอปซื้อขายหุ้น'], answer: 1 },
            { question: 'หลัง COVID-19 Crash มีนาคม 2020 เกิดอะไรขึ้น?', options: ['ตลาดลงต่ออีก 5 ปี', 'S&P 500 ขึ้นกลับมา 100%+ ภายใน 1 ปี', 'ตลาดหุ้นปิดตัว', 'ไม่มีใครได้กำไร'], answer: 1 },
            { question: 'หุ้นที่ลง 50% ต้องขึ้นกี่เปอร์เซ็นต์ถึงจะเท่าทุน?', options: ['50%', '75%', '100%', '150%'], answer: 2 },
        ],
    },
    {
