                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    {activeSection === 'email' && (
                        <div style={card} className="animate-fade-in">
                            ...
                            {isOAuth ? (
                                <div style={{ padding: '16px 20px', borderRadius: 'var(--radius-md)', background: 'var(--bg-elevated)', border: '1px solid var(--border)' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
                                        ...
                                        <span style={{ fontSize: '0.88rem', fontWeight: 600, color: 'var(--text-secondary)' }}>
                                            {oauthProvider === 'google' ? 'จัดการโดย Google' : `จัดการโดย ${oauthProvider}`}
                                        </span>
                                    </div>
                                    <p style={{ fontSize: '0.82rem', color: 'var(--text-muted)', lineHeight: 1.6, margin: 0 }}>
                                        อีเมลนี้เชื่อมต่อกับบัญชี {oauthProvider === 'google' ? 'Google' : oauthProvider} ของคุณ
                                        ไม่สามารถเปลี่ยนได้โดยตรง หากต้องการเปลี่ยนอีเมล กรุณาเปลี่ยนที่บัญชี {oauthProvider === 'google' ? 'Google' : oauthProvider} ของคุณ
                                    </p>
                                </div>
                            ) : emailStep === 'input' ? (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
